...
require(srcDir + "interfaces/4-interface-with-optional-properties");
require(srcDir + "interfaces/5-interface-with-index-signatures");
...
require(srcDir + "classes/2-public-and-private-members");
require(srcDir + "classes/3-readonly-members");
require(srcDir + "classes/4-setters-and-getters");
require(srcDir + "classes/5-class-inheritance");
require(srcDir + "classes/6-abstract-classes");
require(srcDir + "classes/7-protected-members-and-inheritance");
require(srcDir + "classes/8-interface-contracts-and-implements");
require(srcDir + "classes/9-static-properties-and-members");
